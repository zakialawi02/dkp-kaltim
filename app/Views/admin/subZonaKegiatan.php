                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    <?php foreach ($dataSubZona as $K) : ?>
                                        <tr>
                                            <td><?= $K->nama_subzona; ?></td>
                                            <td>
                                                <div class="btn-group mr-2" role="group" aria-label="First group">
                                                    <a href="/admin/kegiatan/edit/<?= $K->id_sub; ?>" class="asbn btn btn-primary bi bi-pencil-square" role="button"></a>
                                                </div>
                                                <div class="btn-group mr-2" role="group" aria-label="First group">
                                                    <form action="/admin/delete_kegiatan/<?= $K->id_sub; ?>" method="post">
                                                        <?= csrf_field(); ?>
