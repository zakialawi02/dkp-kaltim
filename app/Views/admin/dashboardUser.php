                                                                            ...
                                                                            <tr class="">
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <div class="btn-group mr-2" role="group" aria-label="First group" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="lihat data">
                                                                                        <a type="button" role="button" href="/admin/data/permohonan/<?= ($pIzin->stat_appv == '1') ? 'telah-disetujui' : (($pIzin->stat_appv == '0') ? 'menunggu-jawaban' : 'tidak-disetujui'); ?>/lihat/<?= $pIzin->id_perizinan; ?>" class="asbn btn btn-secondary bi bi-eye" data-bs-toggle="tooltip" data-bs-placement="top" title="Lihat" target="_blank"></a>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                                                        <?php endforeach ?>
                                                                        ...
                                                                        <?php foreach ($terimaIzin as $tIzin) : ?>
                                                                            <tr class="">
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <div class="btn-group mr-2" role="group" aria-label="First group" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="lihat data">
                                                                                        <a type="button" role="button" href="/admin/data/permohonan/<?= ($tIzin->stat_appv == '1') ? 'telah-disetujui' : 'tidak-disetujui'; ?>/lihat/<?= $tIzin->id_perizinan; ?>" class="asbn btn btn-secondary bi bi-eye" data-bs-toggle="tooltip" data-bs-placement="top" title="Lihat" target="_blank"></a>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                                                        <?php endforeach ?>
                                                                        ...
                                                                        <?php foreach ($tolakIzin as $sIzin) : ?>
                                                                            <tr class="">
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <div class="btn-group mr-2" role="group" aria-label="First group" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="lihat data">
                                                                                        <a type="button" role="button" href="/admin/data/permohonan/<?= ($sIzin->stat_appv == '1') ? 'telah-disetujui' : 'tidak-disetujui'; ?>/lihat/<?= $sIzin->id_perizinan; ?>" class="asbn btn btn-secondary bi bi-eye" data-bs-toggle="tooltip" data-bs-placement="top" title="Lihat" target="_blank"></a>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                                                        <?php endforeach ?>
