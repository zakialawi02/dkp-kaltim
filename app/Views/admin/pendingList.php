                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($tampilDataIzin as $S) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a type="button" role="button" href="/admin/data/lihat/<?= $S->id_perizinan; ?>/<?= $S->nama; ?>" class="asbn btn btn-info bi bi-binoculars" data-bs-toggle="tooltip" data-bs-placement="top" title="Aksi" target="_blank"> Periksa</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
