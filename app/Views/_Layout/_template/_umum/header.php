...
<nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0 px-4 px-lg-5">
    <a href="/" class="navbar-brand d-flex align-items-center">
        <h2 class="navbar-brand d-flex align-items-center m-0 text-primary navlogo"><img class="img-fluid me-2" src="/img/logo dkp.png" alt="DINAS KELAUTAN DAN PERIKANAN PROVINSI KALIMANTAN TIMUR" style="width: 2.4rem;">DKP KALTIM</h2>
    </a>
