                                                            ...
                                                            <tr>
                                                                <td class="text-left" align="start" valign="top" bgcolor="#FFFFFF" style="text-align: start; padding: 15px 25px;">
                                                                    <p style="font-size: 16px; font-weight: normal;">
                                                                        <bold style="font-weight: 800;">Hello ,</bold>
                                                                    </p>
                                                                    <p style="font-size: 16px; font-weight: normal;">
                                                                        Selamat datang di Simatalaut, terima kasih
                                                                        untuk registrasi anda.</p>
                                                                    <p style="font-size: 16px; font-weight: normal;">
                                                                        Klik tombol dibawah untuk mengaktifkan akun
                                                                        anda.</p>
                                                                    <p style="font-size: 16px; font-weight: normal;"><a class="btn btn-primary" href="<?= url_to('activate-account') . '?token=' . $hash ?>" style="text-decoration: none; display: inline-block; font-weight: 400; line-height: 1.5; text-align: center; vertical-align: middle; cursor: pointer; user-select: none; border: 1px solid transparent; padding: .375rem .75rem; font-size: 1rem; border-radius: 3px; transition: color 0.15s ease-in-out, background-color 0.15s ease-in-out, border-color 0.15s ease-in-out, box-shadow 0.15s ease-in-out; color: #ffffff; background-color: #345DA7; border-color: #345DA7;">Aktifkan
                                                                            Akun Saya</a>.</p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="text-left sm-font" align="start" valign="top" bgcolor="#FFFFFF" style="text-align: start; padding: 15px 25px;">
                                                                    <p style="font-size: 16px; font-weight: normal;">
                                                                        ...
                                                                        klik url ini</p>
                                                                    <p style="font-size: 16px; font-weight: normal;"><a href="<?= url_to('activate-account') . '?token=' . $hash ?>"><?= url_to('activate-account') . '?token=' . $hash ?></a>.
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr>
